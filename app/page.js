...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-cream font-bengali">
          ...
          <div className="flex items-center justify-between h-24">
            ...
            <nav className="hidden lg:flex items-center gap-2">
              <div className="relative">
                <motion.button 
                  ...
                  className="px-6 py-3 text-forest hover:text-sage transition-all duration-300 font-semibold flex items-center gap-2 hover:bg-sage/10 rounded-4xl"
                >
                  <span>পণ্য</span>
                  <motion.svg 
                ...
                {isShopOpen && (
                  <motion.div 
                    ...
                    className="absolute top-full left-0 mt-4 w-80 glassmorphism rounded-4xl shadow-2xl py-4 border border-sage/20"
                  >
                    ...
                    <Link href="/menu?category=vegetables" className="flex items-center gap-4 px-6 py-4 text-forest hover:bg-sage/10 transition-all group">
                      <span className="text-3xl">🥬</span>
                      <div>
                        <p className="font-bold">শাক-সবজি</p>
                        <p className="text-sm text-sage">তাজা সবজি</p>
                      </div>
                    </Link>
                    <Link href="/menu?category=fruits" className="flex items-center gap-4 px-6 py-4 text-forest hover:bg-sage/10 transition-all group">
                      <span className="text-3xl">🍎</span>
                      <div>
                        <p className="font-bold">ফলমূল</p>
                        <p className="text-sm text-sage">মৌসুমী ফল</p>
                      </div>
                    </Link>
                    <Link href="/menu?category=dairy" className="flex items-center gap-4 px-6 py-4 text-forest hover:bg-sage/10 transition-all group">
                      <span className="text-3xl">🥛</span>
                      <div>
                        <p className="font-bold">দুগ্ধজাত</p>
                        <p className="text-sm text-sage">খামারের দুধ ও ডিম</p>
                      </div>
                    </Link>
                  </motion.div>
                )}
              ...
              <motion.div whileHover={{ scale: 1.05 }} className="relative">
                ...
                {isResourcesOpen && (
                  <motion.div 
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="absolute top-full left-0 mt-4 w-72 glassmorphism rounded-4xl shadow-2xl py-4 border border-sage/20"
                  >
            ...
            <div className="flex items-center gap-3">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="p-3 hover:bg-sage/10 rounded-4xl transition-all"
              >
              ...
              <motion.button 
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="relative p-3 hover:bg-sage/10 rounded-4xl transition-all"
              >
                <svg className="w-6 h-6 text-forest" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <motion.span 
                  ...
                  className="absolute -top-1 -right-1 w-6 h-6 bg-forest text-cream text-xs rounded-full flex items-center justify-center font-bold"
                >
                  {cartCount}
                </motion.span>
              </motion.button>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/dashboard" className="px-8 py-3 bg-forest text-cream rounded-4xl font-bold hover:bg-forest/90 transition-all shadow-lg">
                  কেনাকাটা শুরু করুন
                </Link>
              </motion.div>
            </div>
      ...
      {/* Footer */}
      <footer className="py-16 px-6 lg:px-12 bg-forest/95 text-cream">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-14 h-14 bg-sage rounded-4xl flex items-center justify-center">
                  <svg className="w-8 h-8 text-forest" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                </div>
                <span className="text-2xl font-extrabold">খামার থেকে টেবিল</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sage">
                ...
                <li><Link href="/dashboard" className="hover:text-cream transition-colors">আমার অ্যাকাউন্ট</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="font-bold text-lg mb-4">সহায়তা</h4>
              <ul className="space-y-3 text-sage">
                ...
                <li><a href="#" className="hover:text-cream transition-colors">ডেলিভারি তথ্য</a></li>
                <li><a href="#" className="hover:text-cream transition-colors">রিটার্ন নীতি</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-sage/30 pt-8 text-center text-sage">
